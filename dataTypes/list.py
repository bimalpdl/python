...
# we can also use negative indexing to access the list elements, negative index starts from -1
list2 = ["Acer", "Lenovo", "Xiaomi", "Disney"]
print(list[-1])   # prints the first element from back i.e Disney
...
list3 = ['B', 'I', 'M', 'A', 'L', 'I']
print(list3[1:5])   # prints item from index 1 to index 4
